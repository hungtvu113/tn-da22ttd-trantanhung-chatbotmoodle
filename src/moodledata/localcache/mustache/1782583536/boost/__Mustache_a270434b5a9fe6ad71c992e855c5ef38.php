...
class __Mustache_a270434b5a9fe6ad71c992e855c5ef38 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8c0764a63b31ee773247520f5e9e74b6($context, $indent, $value);
...
';
    ...
    private function section8c0764a63b31ee773247520f5e9e74b6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <a data-toggle="collapse"
               ...
               class="btn btn-icon mr-3 icons-collapse-expand stretched-link fheader {{#collapsed}}collapsed{{/collapsed}}"
            >
...
';
                ...
                $buffer .= 'container"
';
                $buffer .= $indent . '               class="btn btn-icon mr-3 icons-collapse-expand stretched-link fheader ';
                $value = $context->find('collapsed');
