...
class __Mustache_8e8b34d6643a936d9a3ac30277444fb2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'blockEd855b155096c277fd9352b9fa3d305f'),
            ));
...
';
    ...
    public function blockEd855b155096c277fd9352b9fa3d305f($context)
    {
        $indent = $buffer = '';
