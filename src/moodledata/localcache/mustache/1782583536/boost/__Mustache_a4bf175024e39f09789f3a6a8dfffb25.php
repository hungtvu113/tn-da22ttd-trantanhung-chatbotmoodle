...
class __Mustache_a4bf175024e39f09789f3a6a8dfffb25 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div data-filterregion="filter" data-filter-type="">
';
...
';
        ...
        $buffer .= '</legend>
';
        $buffer .= $indent . '        <div class="border-radius my-2 p-2 bg-white border d-flex flex-column flex-md-row align-items-md-stretch mr-0 ml-0 row">
';
        $buffer .= $indent . '            <div class="d-flex flex-column flex-md-row align-items-md-center my-1">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <label class="sr-only pt-2  my-1" for="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">';
        $value = $context->find('str');
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '            <select class="custom-select my-1 mb-md-0 mr-md-2" data-filterfield="type" id="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        ...
        $buffer .= $this->sectionFd0423a9495bdf4847cafa17ba2daa35($context, $indent, $value);
        $buffer .= $indent . '            </select>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div data-filterregion="value" class="d-md-block flex-column align-items-start flex-lg-row my-1"></div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionFd0423a9495bdf4847cafa17ba2daa35(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
