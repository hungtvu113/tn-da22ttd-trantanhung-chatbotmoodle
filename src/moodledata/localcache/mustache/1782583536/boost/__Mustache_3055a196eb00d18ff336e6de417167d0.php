...
class __Mustache_3055a196eb00d18ff336e6de417167d0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <div class="fp-repo-items card" tabindex="0">
';
        $buffer .= $indent . '                <div class="fp-navbar bg-faded border-bottom p-2 clearfix icon-no-spacing">
';
        $buffer .= $indent . '                    <div>
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-content mb-1"></div>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
