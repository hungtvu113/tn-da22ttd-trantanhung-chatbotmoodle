...
class __Mustache_d3bcc480f1c0bf09ddf2a34f1a0cb909 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawerheading' => array($this, 'blockBbbefc93050c0940df7cdb286c4f9404'),
                'drawercontent' => array($this, 'blockDcd8d287965dc5cca764b7473a5f4eae'),
...
';
    ...
    private function section6d359fc11bd15462adc7d7a7d678d7cb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionD1e4a604718ebb33e8aeabea9aec7064(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section6d359fc11bd15462adc7d7a7d678d7cb($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $context->pop();
            }
    ...
    private function sectionAc8b3d013afc4a0e796f8ff59304826c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionD1e4a604718ebb33e8aeabea9aec7064($context, $indent, $value);
                $value = $context->find('haschildren');
                if (empty($value)) {
...
';
    ...
    public function blockBbbefc93050c0940df7cdb286c4f9404($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockDcd8d287965dc5cca764b7473a5f4eae($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div class="list-group">
';
        $value = $context->find('mobileprimarynav');
        $buffer .= $this->sectionAc8b3d013afc4a0e796f8ff59304826c($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
