...
class __Mustache_1143566e1476d21f72871759121dd2ec extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'block7260ad5b6b4be9b72688e5c16d3c7f0c'),
...
';
    ...
    public function block7260ad5b6b4be9b72688e5c16d3c7f0c($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        $value = $context->find('pix');
