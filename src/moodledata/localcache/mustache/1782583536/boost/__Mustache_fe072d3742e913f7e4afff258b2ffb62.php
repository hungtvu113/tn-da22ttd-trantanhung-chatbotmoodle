...
class __Mustache_fe072d3742e913f7e4afff258b2ffb62 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <small
';
        $buffer .= $indent . '                class="hidden ml-1"
';
...
';
        ...
        $buffer .= ' badge rounded-pill bg-primary text-white ml-auto"
';
