...
class __Mustache_4fe1fee279971d1627a69522e0efdf2b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section52da021cc634abc2daf61f9910b5c286($context, $indent, $value);
...
';
    ...
    private function section52da021cc634abc2daf61f9910b5c286(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" data-status="0" type="button" class="btn btn-light ml-auto mr-2">';
                $value = $context->find('str');
