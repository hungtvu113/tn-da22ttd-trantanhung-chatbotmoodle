...
class __Mustache_a696878c627cc45a035c2cbf4f9f9535 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                <div class="fp-file mb-3">
';
        $buffer .= $indent . '                    <label>';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-saveas mb-3">
';
        $buffer .= $indent . '                    <label>';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-setauthor mb-3">
';
        $buffer .= $indent . '                    <label>';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-setlicense mb-3">
';
