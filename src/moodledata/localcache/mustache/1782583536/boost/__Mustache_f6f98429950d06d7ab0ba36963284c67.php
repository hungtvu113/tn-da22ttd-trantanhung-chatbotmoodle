...
class __Mustache_f6f98429950d06d7ab0ba36963284c67 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <form>
';
        $buffer .= $indent . '            <fieldset class="mb-3 row flex-column">
';
...
';
        $buffer .= $indent . '            <div class="fp-saveas mb-3 row">
';
...
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="fp-setauthor mb-3 row">
';
        $buffer .= $indent . '                <label class="col-form-label">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="fp-setlicense mb-3 row">
';
