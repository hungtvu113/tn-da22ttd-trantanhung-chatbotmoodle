...
class __Mustache_f99b0b15b03667a9818d219c3773f7d0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="mb-3 mx-0">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                <div class="fp-saveas mb-3 row mx-0">
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8 d-flex flex-wrap align-items-center"><input class="form-control" type="text"/></div>
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-author mb-3 row mx-0">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4 px-0">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-license mb-3 row mx-0">
';
        ...
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-path mb-3 row mx-0">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4 px-0">';
        $value = $context->find('str');
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8 d-flex flex-wrap align-items-center pr-0">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-original mb-3 row mx-0">
';
        ...
        $buffer .= '</div>
';
        $buffer .= $indent . '                    <div class="col-8 d-flex flex-wrap align-items-center">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-reflist mb-3 row mx-0">
';
        $buffer .= $indent . '                    <div class="form-control-label col-4 px-0">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '        <div class="fp-select-buttons mb-3">
';
