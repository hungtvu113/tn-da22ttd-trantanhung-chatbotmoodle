...
class __Mustache_f4e6fece467a58522fd80f267302446f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9ed4464c15fb8f8684cce26058a3a09c($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionDebe1cec7e7a487b587a416dda0b2bf1($context, $indent, $value);
        $buffer .= $indent . '        >
';
        $buffer .= $indent . '            ';
...
';
        $value = $context->find('description');
        $buffer .= $this->section6d56c26d4c4ac3dc5415c73b6be99629($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
    ...
    private function section9ed4464c15fb8f8684cce26058a3a09c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDebe1cec7e7a487b587a416dda0b2bf1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6d56c26d4c4ac3dc5415c73b6be99629(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
