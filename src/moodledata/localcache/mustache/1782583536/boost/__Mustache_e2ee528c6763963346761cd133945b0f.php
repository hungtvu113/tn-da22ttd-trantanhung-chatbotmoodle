...
class __Mustache_e2ee528c6763963346761cd133945b0f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6afcf3cfa5da5297644cfc06b6f164c7($context, $indent, $value);
        $buffer .= $indent . '</select>
';
    ...
    private function section6afcf3cfa5da5297644cfc06b6f164c7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
