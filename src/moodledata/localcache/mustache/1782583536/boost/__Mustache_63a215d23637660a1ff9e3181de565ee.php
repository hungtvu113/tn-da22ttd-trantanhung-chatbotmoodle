...
class __Mustache_63a215d23637660a1ff9e3181de565ee extends Mustache_Template
{
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->sectionD04f306872719f4dc984287c93e54f76($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
    ...
    private function sectionD04f306872719f4dc984287c93e54f76(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
