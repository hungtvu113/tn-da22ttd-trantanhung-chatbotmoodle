...
class __Mustache_1fba35c4baa659f763943dac90101090 extends Mustache_Template
{
...
';
                    $buffer .= $indent . '                    href="#coursecontentcollapseid';
                    $value = $this->resolveValue($context->find('id'), $context);
                    $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                    $buffer .= '"
';
                    $buffer .= $indent . '                    id="collapsesectionid';
                    $value = $this->resolveValue($context->find('id'), $context);
                    $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                    $buffer .= '"
';
                    ...
                    $buffer .= '"
';
                    $buffer .= $indent . '                    aria-controls="coursecontentcollapseid';
                    $value = $this->resolveValue($context->find('id'), $context);
                    $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                    $buffer .= '"
';
                    $buffer .= $indent . '                    class="btn btn-icon mr-3 icons-collapse-expand justify-content-center
';
                    $buffer .= $indent . '                        ';
                    $value = $context->find('contentcollapsed');
...
';
                    $buffer .= $indent . '                </a>
';
                    $buffer .= $indent . '                <h3 class="h4 sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
';
