...
/**
 * Strings for component 'vitero', language 'vi', version '4.4'.
 *
 * @package     vitero
 * @category    string
...
$string['adminusername_desc'] = 'Tên người dùng Vitero của người có quyền thêm phiên, người dùng, v.v.';
$string['alreadyover'] = 'Cuộc họp này đã kết thúc.';
$string['appointmentfields'] = 'Các khu vực cuộc hẹn';
...
$string['clickhereformeeting'] = 'Bấm vào đây để tham gia phiên';
...
$string['errorcode102'] = 'Tên viết tắt của khách hàng mới đã tồn tại';
$string['errorcode103'] = 'Người dùng không được đi kèm với khách hàng';
...
$string['errorcode3'] = 'Lỗi bên trong';
$string['errorcode302'] = 'Danh sách-Chỉ mục không hợp lệ';
$string['errorcode303'] = 'Giá trị của một thuộc tính không hợp lệ';
...
$string['errorcode451'] = 'Kích thước tệp quá lớn vượt quá tệp bạn cố tải lên';
$string['errorcode452'] = 'Loại tệp không được phép';
$string['errorcode501'] = 'Xung khắc khi đặt chỗ - giấy phép bị vượt quá (lượt đặt chỗ mới xung khắc với lượt đặt chỗ hiện có và giấy phép không cho phép đặt chỗ khác trong khoảng thời gian này)';
$string['errorcode502'] = 'Lựa chọn mô-đun không hợp lệ';
$string['errorcode505'] = 'Đặt chỗ từ trước Bạn đã đặt chỗ từ trước rồi';
...
$string['errorcode51'] = 'Đã tồn tại Một người dùng khác với tên này';
$string['errorcode52'] = 'Đã tồn tại Một người dùng khác với email này';
...
$string['errorcode601'] = 'Không tìm thấy Node';
...
$string['missingcertificate'] = 'Tệp chứng chỉ bị thiếu: {$a}';
$string['modulename'] = 'Vitero';
$string['modulename_help'] = 'Sử dụng mô-đun vitero để liên kết Moodle và Vitero.';
$string['modulenameplural'] = 'Cuộc họp Vitero';
$string['nologinhint'] = 'Sau khi ID phiên được tạo, bạn cần lưu hoạt động trước khi có thể đến khu vực quản trị Vitero. Trong khu vực quản trị Vitero, bạn có thể tạo các thư mục và tải lên các tài liệu.

Sau khi lưu, bạn cần nhấp vào biểu tượng “cập nhật” của hoạt động để di chuyển về tab cấu hình này. Sau đó, bạn  sẽ tìm thấy một nút để nhấp vào tại đây.';
$string['notstartedyet'] = 'Cuộc họp này vẫn chưa bắt đầu.';
$string['novmssessioncode'] = 'Không thể lấy mã phiên VMS. Vui lòng kiểm tra kết nối';
$string['paststarttime'] = 'Thời gian bắt đầu không được là bây giờ hoặc quá khứ';
...
$string['privacy:metadata:vitero_remusers:lastemail'] = 'Địa chỉ email cuối được gửi đến Vitero';
$string['privacy:metadata:vitero_remusers:lastfirstname'] = 'Tên đã được gửi đến Vitero';
$string['privacy:metadata:vitero_remusers:lastlastname'] = 'Tên họ đã được gửi đến Vitero';
$string['privacy:metadata:vitero_remusers:timecreated'] = 'Thời gian thông tin chi tiết đầu tiên về người dùng  được gửi đến Vitero';
$string['privacy:metadata:vitero_remusers:timeupdated'] = 'Thời gian chi tiết cuối cùng về người dùng được gửi đến Vitero';
...
$string['roomsize'] = 'Kích cỡ phòng';
$string['root'] = 'Đường dẫn gốc Vitero';
$string['root_desc'] = 'Đường dẫn gốc của Vitero trong máy chủ (tùy chọn)';
$string['startbuffer'] = 'Khởi động Buffer (phút)';
$string['starttime'] = 'Thời gian bắt đầu';
$string['syncavatars'] = 'Đồng bộ hóa hình đại diện';
...
$string['vitero:teamleader'] = 'Trưởng nhóm Vitero';
$string['viteroappointment'] = 'Cuộc họp trên Vitero';
$string['viterofieldset'] = 'Bộ trường mẫu tùy chỉnh';
$string['viteroname'] = 'Vitero';
$string['viteroname_help'] = 'Đây là nội dung của công cụ trợ giúp chú giải  được liên kết với trường viteroname. Cú pháp đánh dấu được hỗ trợ.';
