...
/**
 * Strings for component 'repository', language 'vi', version '4.4'.
 *
 * @package     repository
 * @category    string
...
$string['activaterep'] = 'Các kho lưu trữ đang hoạt động';
$string['activerepository'] = 'Các trình bổ trợ kho hiện hữu';
$string['activitybackup'] = 'Sao lưu hoạt động';
$string['add'] = 'Thêm';
$string['addfile'] = 'Thêm...';
$string['addfiletext'] = 'Thêm file';
$string['addplugin'] = 'Thêm trình bổ trợ kho';
$string['aliaseschange'] = 'Có {$a} đường liên kết dẫn tới file này. Nếu bạn kích hoạt thì những địa chỉ mà hiện giờ đang dẫn tới file sẽ được cập nhật tự động để sử dụng bản sao chép của file.';
...
$string['areamainfile'] = 'File chính';
...
$string['attachedfiles'] = 'Các file được đính kèm';
$string['attachment'] = 'Đính kèm';
$string['author'] = 'Tác giả';
$string['automatedbackup'] = 'Các bản sao lưu tự động';
$string['back'] = 'Trở về';
$string['backtodraftfiles'] = 'Trở về trình quản lị tệp nháp';
$string['cacheexpire'] = 'Thời hạn bộ đệm';
$string['cannotaccessparentwin'] = 'Khi dùng HTTPS, kho sẽ không được tự động làm mới. Thay vào đó, bạn cần phải quay lại bộ chọn tệp và chọn khi lại lần nữa.';
$string['cannotdelete'] = 'Không thế xóa tệp này.';
...
$string['cannotunzipcontentunreadable'] = 'Không thể giải nén file này vì không thể đọc được nội dung của nó.';
$string['cannotunzipquotaexceeded'] = 'Không thể giải nén file này vì sẽ vượt kích thước tối đa cho phép trong vùng nháp này.';
$string['choosealink'] = 'Chọn một liên kết...';
$string['chooselicense'] = 'Chọn giấy phép';
$string['chooselicense_help'] = 'Đi theo những đường dẫn này để có thêm thông tin liên quan tới các lựa chọn về giấy phép:';
...
$string['confirmdeleteselectedfile'] = 'Bạn có chắc muốn xóa những file {$a} đã được chọn?';
...
$string['confirmrenamefile'] = 'Bạn có chắc muốn đặt tên lại/xóa tệp này?';
...
$string['displayasdetails'] = 'Hiển thị dưới dạng chi tiết file';
$string['displayasicons'] = 'Hiển thị dưới dạng biểu tượng file';
$string['displayastree'] = 'Hiển thị dưới dạng cây file';
...
$string['download'] = 'Tải';
$string['downloadallfiles'] = 'Tải về toàn bộ các file';
...
$string['errornotyourfile'] = 'Bạn chỉ có thể chọn những file mà bạn đã thêm.';
$string['errorpostmaxsize'] = 'File mà bạn đang cố đăng tải có kích thước quá to, khiến cho máy chủ không xử lí được.';
...
$string['folderrecurse'] = 'Thư mục không thể bị chuyển sang thư mục con của nó.';
...
$string['logintoaccount'] = 'Đăng nhập tài khoản {$a} của bạn';
$string['logout'] = 'Thoát';
$string['lostsource'] = 'Lỗi. Thiếu nguồn. {$a}';
$string['makefileinternal'] = 'Tạo bản sao tệp này';
$string['makefilelink'] = 'Liên kết tới file ngoài';
$string['makefilereference'] = 'Liên kết tới file';
$string['manage'] = 'Quản lí kho';
$string['manageurl'] = 'Quản lí';
$string['manageuserrepository'] = 'Quản lí kho cá nhân';
$string['missingsourcekey'] = 'Đang thiếu mã nguồn. Phải cung cấp mã để lấy lại file.';
...
$string['nofilesselected'] = 'Không có file nào được chọn';
...
$string['referencesexist'] = 'Có {$a} đường liên kết dẫn tới file này';
$string['referenceslist'] = 'Các đường dẫn';
...
$string['setupdefaultplugins'] = 'Thiết lập các trình bổ trợ kho mặc định';
$string['siteinstances'] = 'Các thực thể kho của trang';
$string['size'] = 'Kích thước';
$string['sourcekeymismatch'] = 'Nguồn URL không khớp với mã nguồn';
$string['submit'] = 'Nộp';
$string['sync'] = 'Đồng bộ';
...
$string['usenonjsfilemanager'] = 'Mở trình quản lí file trong cửa sổ khác';
$string['usenonjsfilepicker'] = 'Mở bộ chọn file trong cửa sổ khác';
