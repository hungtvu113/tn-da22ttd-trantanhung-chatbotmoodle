...
/**
 * Strings for component 'plugin', language 'vi', version '4.4'.
 *
 * @package     plugin
 * @category    string
...
$string['cancelinstallall'] = 'Hủy các cài đặt mới ({$a})';
$string['cancelinstallhead'] = 'Đang hủy cài đặt các trình bổ trợ';
$string['cancelinstallinfodir'] = 'Xóa tệp: {$a}';
$string['cancelinstallone'] = 'Hủy cài đặt này';
$string['cancelupgradeall'] = 'Hủy nâng cấp ({$a})';
$string['cancelupgradehead'] = 'Đang khôi phục phiên bản cũ của các trình bổ trợ';
$string['cancelupgradeone'] = 'Hủy bản nâng cấp này';
...
$string['dependencyuploadmissing'] = 'Đăng tải các file nén';
...
$string['isenabled'] = 'Được kích hoạt không?';
$string['misdepinfoplugin'] = 'Thông tin trình bổ trợ';
...
$string['notsupported'] = 'Trình bổ trợ có thể không tương thích với phiên bản Moodle {$a}';
...
$string['overviewall'] = 'Tất cả các trình bổ trợ';
$string['overviewext'] = 'Các trình bổ trợ bổ sung';
$string['overviewupdatable'] = 'Các bản cập nhật có sẵn';
$string['packagesdownloading'] = 'Đang tải về {$a}';
$string['packagesextracting'] = 'Đang chiết xuất {$a}';
$string['packagesvalidating'] = 'Đang đánh giá {$a}';
$string['packagesvalidatingfailed'] = 'Hủy cài đặt vì thất bại trong việc đánh giá';
$string['packagesvalidatingok'] = 'Đánh giá thành công, tiếp tục cài đặt';
$string['plugincheckall'] = 'Tất cả các trình bổ trợ';
$string['plugincheckattention'] = 'Những trình bổ trợ cần chú ý';
$string['pluginchecknone'] = 'Không có trình bổ trợ nào yêu cầu sự chú ý từ bạn';
$string['pluginchecknotice'] = 'Trang này hiển thị các trình bổ trợ yêu cầu sự chú ý của bạn trong quá trình nâng cấp, bao gồm các trình bổ trợ mới mà bạn định cài đặt, các trình bổ trợ sắp được nâng cấp và bất kì trình bổ trợ còn thiếu nào. Các trình bổ trợ bổ sung sẽ hiển thị nếu có bản cập nhật cho chúng. Khuyến khích bạn kiểm tra liệu có các phiên bản trình bổ trợ gần đây hơn không và cập nhật mã nguồn của chúng trước khi tiếp tục với bản nâng cấp Moodle này.';
...
$string['type_antivirus'] = 'Trình bổ trợ chống virus';
$string['type_antivirus_plural'] = 'Các trình bổ trợ chống virus';
...
$string['type_contentbank'] = 'Ngân hành nội dung';
$string['type_contentbank_plural'] = 'Các trình bổ trợ ngân hàng nội dung';
$string['type_coursereport'] = 'Báo cáo khóa học';
$string['type_coursereport_plural'] = 'Các báo cáo khóa học';
$string['type_dataformat'] = 'Hình thức dữ liệu';
$string['type_dataformat_plural'] = 'Các hình thức dữ liệu';
...
$string['type_repository_plural'] = 'Các kho chứa dữ liệu';
$string['type_search'] = 'Công cụ tìm kiếm';
$string['type_search_plural'] = 'Các công cụ tìm kiếm';
...
$string['uninstall'] = 'Hủy cài đặt';
$string['uninstallconfirm'] = 'Bạn sắp hủy cài đặt trình bổ trợ <em>{$a->name}</em>. Điều này sẽ dẫn tới việc xóa toàn bộ mọi thứ trong CSDL liên quan tới trình bổ trợ này, bao gồm các thiết đặt, các bản lưu, các file của người dùng mà được quản lí bới trình bổ trợ,... Sẽ không có bất kì cách nào để đảo ngược quá trình và tự thân Moodle cũng không tạo bất kì bản dự phòng để phục hồi dữ liệu. Bạn có thực sự muốn tiếp tục không?';
$string['uninstalldeleteconfirm'] = 'Toàn bộ dữ liệu liên quan tới trình bổ trợ  <em>{$a->name}</em> đã bị xóa khởi CSDL. Để ngăn không cho trình bổ trợ tự cài đặt lại, phải xóa thư mục của nỏ <em>{$a->rootdir}</em> khỏi máy chủ của bạn. Bạn có muốn xóa thư mục trình bổ trợ bây giờ không?';
$string['uninstallextraconfirmenrol'] = 'Có {$a->enrolments} ghi danh người dùng.';
$string['uninstalling'] = 'Đang hủy cài đặt  {$a->name}';
$string['updateavailable'] = 'Phiên bản {$a} mới đang có sẵn!';
$string['updateavailable_moreinfo'] = 'Thêm thông tin...';
$string['updateavailable_release'] = 'Nhả {$a}';
$string['updatepluginconfirm'] = 'Xác nhận nâng cấp trình bổ trợ';
$string['validationmsg_componentmismatchname'] = 'Tên trình bổ trợ không khớp';
$string['validationmsg_componentmismatchtype'] = 'Loại trình bổ trợ không khớp';
$string['validationmsg_filenotexists'] = 'Không tìm thấy file được dẫn xuất';
$string['validationmsg_filesnumber'] = 'Không tìm thấy đủ file trong gói';
$string['validationmsg_filestatus'] = 'Không thể dẫn xuất tất cả các file';
$string['validationmsg_foundlangfile'] = 'Tìm thấy file ngôn ngữ';
$string['validationmsg_missingcomponent_link'] = 'Development:version.php';
$string['validationmsg_missingversionphp'] = 'Không tìm thấy file phiên bản .php';
$string['validationmsg_onedir'] = 'Cấu trúc không hợp lệ của gói nén.';
$string['validationmsg_pluginversion'] = 'Phiên bản tình bổ trợ';
$string['validationmsg_pluginversiontoolow'] = 'Đã cài đặt phiên bản trình bổ trợ cao hơn';
$string['validationmsg_requiresmoodle'] = 'Phiên bản Moodle được yêu cầu';
$string['validationmsg_rootdir'] = 'Tên của trình bổ trợ sắp được cài đặt';
$string['validationmsg_rootdirinvalid'] = 'Tên trình bổ trợ không hợp lệ';
$string['validationmsg_unknowntype'] = 'Không rõ loại trình bổ trợ';
$string['validationmsglevel_debug'] = 'Vá lỗi';
