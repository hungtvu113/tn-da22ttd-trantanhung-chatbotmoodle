...
/**
 * Strings for component 'question', language 'vi', version '4.4'.
 *
 * @package     question
 * @category    string
...
$string['adminreport'] = 'Báo cáo về những vấn đề có thể gặp phải trong CSDL câu hỏi của bạn.';
...
$string['cannotdeletetopcat'] = 'Không thể xóa các danh mục trên đầu.';
$string['cannotedittopcat'] = 'Không thể chỉnh sửa các danh mục trên đầu.';
...
$string['cannotunhidequestion'] = 'Bỏ ẩn câu hỏi thất bại.';
...
$string['categorymove'] = 'Danh mục  \'{$a->name} \' bao gồm  {$a->count} câu hỏi (một vài câu trong số này đang bị ẩn hoặc ở dạng ngẫu nhiên mà đang được dùng để làm bài trắc nghiệm). Xin hãy  chọn danh mục khác để di chuyển chúng đi.';
...
$string['cwrqpfs'] = 'Các câu hỏi ngẫu nhiên được tạo bằng cách chọn câu hỏi từ các danh mục phụ.';
$string['cwrqpfsnoprob'] = 'Không có danh mục câu hỏi nào trong trang của bạn bị ảnh hưởng bới vấn đề \'Các câu hỏi ngẫu nhiên được tạo bằng cách chọn câu hỏi từ các danh mục phụ\'.';
...
$string['deletecoursecategorywithquestions'] = 'Có các câu hỏi trong ngân hàng câu hỏi liên quan tới danh mục khóa học này. Chúng sẽ bị xóa nếu bạn kích hoạt. Bạn có thể di chuyển chúng trước bằng cách sử dụng giao diện ngân hàng câu hỏi.';
...
$string['errorduringpost'] = 'Đã xảy ra lỗi trong quá trình hậu xử lí!';
$string['errorduringpre'] = 'Đã xảy ra lỗi trong quá trình tiền xử lí!';
$string['errorduringproc'] = 'Đã xảy ra lỗi trong quá trình xử lí!';
...
$string['errorsavingcomment'] = 'Lỗi khi đang lưu bình luận cho câu hỏi {$a->name} trong CSDL.';
$string['errorsavingflags'] = 'Lỗi lưu trạng thái cờ.';
$string['errorupdatingattempt'] = 'Lỗi khi cập nhật lần làm {$a->id} trong CSDL.';
$string['eventquestioncategorycreated'] = 'Danh mục câu hỏi đã được tạo';
$string['eventquestioncategorydeleted'] = 'Danh mục câu hỏi bị xóa';
$string['eventquestioncategorymoved'] = 'Danh mục câu hỏi bị di chuyển';
$string['eventquestioncategoryupdated'] = 'Danh mục câu hỏi được cập nhật';
$string['eventquestioncategoryviewed'] = 'Danh mục câu hỏi được xem';
$string['eventquestioncreated'] = 'Câu hỏi được tạo';
$string['eventquestiondeleted'] = 'Câu hỏi bị xóa';
$string['eventquestionmoved'] = 'Câu hỏi bị di chuyển';
$string['eventquestionsexported'] = 'Các câu hỏi được xuất';
$string['eventquestionsimported'] = 'Các câu hỏi được nhập';
$string['eventquestionupdated'] = 'Câu hỏi được cập nhật';
$string['eventquestionviewed'] = 'Câu hỏi được xem';
$string['export'] = 'Xuất';
...
$string['exportonequestion'] = 'Tải về câu hỏi này dưới hình thức Moodle XML';
...
$string['idnumber_help'] = 'Nếu được dùng, số ID phải là duy nhất khi nằm trong mỗi danh mục câu hỏi. Điều này cung cấp một cách khác để nhận dạng một câu hỏi mà đôi khi hữu dụng nhưng thường được để trống.';
...
$string['needtochoosecat'] = 'Bạn cần phải chọn 1 danh mục để chuyển câu hỏi này sang hoặc nhấn \'hủy\'.';
...
$string['noprobs'] = 'Không tìm thấy vấn đề nào trong CSDL câu hỏi của bạn.';
...
$string['notenoughdatatomovequestions'] = 'Bạn cần cung cấp ID cho câu hỏi mà bạn muốn di chuyển.';
...
$string['penaltyforeachincorrecttry_help'] = 'Khi các câu hỏi đang chạy bằng cách sử dụng hành vi \'Tương tác với nhiều lần thử\' hoặc \'Chế độ thích nghi\'thì học viên sẽ có vài lần thử để đưa ra  câu trả lời đúng, và lựa chọn này kiểm soát mức phạt dành cho họ đối với mỗi lần thử sai.
...
Đối với những câu hỏi có nhiều phần, cách tính điểm này sẽ được áp dụng độc lập với mỗi phần của câu hỏi. Chi tiết dựa vào loại câu hỏi và điều này cũng có thể trở nên phức tạp, nhưng nguyên tắc là để cho học viên điểm một cách công bằng nhất có thể đối với kiến thức mà họ thể hiện qua việc trả lời các câu hỏi.';
...
$string['privacy:metadata:database:question:generalfeedback'] = 'Nhận xét chung về câu hỏi này.';
$string['privacy:metadata:database:question:modifiedby'] = 'Người mà lần cuối cập nhật câu hỏi.';
$string['privacy:metadata:database:question:name'] = 'Tên câu hỏi.';
$string['privacy:metadata:database:question:timecreated'] = 'Ngày giờ tạo câu hỏi.';
$string['privacy:metadata:database:question:timemodified'] = 'Ngày giờ cập nhật câu hỏi.';
$string['privacy:metadata:database:question_attempts:responsesummary'] = 'Một bản tổng hợp về câu trả lời dành cho câu hỏi.';
$string['privacy:metadata:database:question_attempts:timemodified'] = 'Thời điểm cập nhật lần làm câu hỏi.';
...
$string['questioncategories'] = 'Các danh mục câu hỏi';
...
$string['questionformtagheader'] = '{$a} thẻ';
...
$string['questionsaveerror'] = 'Có lỗi xảy ra khi đang lưu câu hỏi - ({$a})';
$string['questionsinuse'] = '(* Các câu hỏi được đánh dấu bởi một dấu * là được sử dụng trong một số bài trắc nghiệm. Những câu hỏi này sẽ không bị xóa mà chỉ bị ẩn đi.)';
...
$string['questiontags'] = 'Các thẻ câu hỏi';
...
$string['technicalinforesponsesummary'] = 'Tổng hợp câu trả lời: {$a}';
...
$string['upgradeproblemcategoryloop'] = 'Phát hiện vấn đề khi đang nâng cấp các danh mục câu hỏi. Có một vòng lặp trong cây danh mục. Id của danh mục bị ảnh hưởng là {$a}.';
