...
/**
 * Strings for component 'scorm', language 'vi', version '4.4'.
 *
 * @package     scorm
 * @category    string
...
$string['activityloading'] = 'Bạn sẽ được tự động điều hướng tới hoạt động trong vòng';
$string['activityoverview'] = 'Bạn có các gói SCORM cần được lưu ý';
$string['activitypleasewait'] = 'Đang tải hoạt động, xin chờ ...';
$string['adminsettings'] = 'Các thiết đặt quản trị';
$string['aiccuserid_desc'] = 'Tiêu chuẩn AICC đối với tên người dùng rất nghiêm ngặt khi so sánh với Moodle, và nó chỉ cho phép dùng các kí tự chữ số, dấu gạch ngang và dấu gạch dưới. Dấu chấm, khoảng cách và biểu tượng @ đều không được dùng. Nếu được kích hoạt, thì thay vì tên người dùng, số ID người dùng sẽ được chuyển tới gói AICC.';
$string['allowtypeexternal'] = 'Cho phép kiểu gói bên ngoài';
$string['allowtypeexternalaicc_desc'] = 'Nếu được kích hoạt thì điều này cho phép một url trực tiếp tới một gói AICC đơn giản.';
$string['allowtypelocalsync'] = 'Kích hoạt kiểu gói được tải về';
$string['areacontent'] = 'Nội dung trong các file';
$string['areapackage'] = 'Gói file';
$string['attempt'] = 'Thử';
$string['attempt1'] = '1 lần thử';
$string['attempts'] = 'Các lần thử';
$string['attemptsmanagement'] = 'Quản lí các lần thử';
$string['attemptstatusmy'] = 'Chỉ trang tổng quan';
$string['attemptsx'] = '{$a} lần làm thử';
...
$string['averageattempt'] = 'Những lần thử trung bình';
$string['badarchive'] = 'Bạn phải cung cấp một file nén hợp lệ';
$string['browse'] = 'Xem trước';
$string['browsed'] = 'Đã tìm kiếm';
$string['browsemode'] = 'Chế độ xem trước';
$string['calculatedweight'] = 'Khối lượng được tính toán';
$string['calendarend'] = '{$a} kết thúc';
$string['calendarstart'] = '{$a} bắt đầu';
$string['cannotfindsco'] = 'Không tìm thấy SCO';
$string['chooseapacket'] = 'Chọn hoặc cập nhật một gói';
$string['closebeforeopen'] = 'Bạn đã định ngày kết thúc trước ngày bắt đầu.';
$string['compatibilitysettings'] = 'Các thiết đặt tương thích';
...
$string['completiondetail:completionstatuscompletedorpassed'] = 'Hoàn thành hoặc qua hoạt động';
$string['completiondetail:completionstatuspassed'] = 'Qua hoạt động';
$string['completionscorerequired'] = 'Yêu cầu điểm tối thiểu';
$string['completionscorerequired_help'] = 'Kích hoạt cài đặt này cũng đồng nghĩa với việc người dùng sẽ phải đạt được một số điểm tối thiểu để được đánh dấu là đã hoàn thành trong hoạt động SCORM này, cũng như bất kì yêu cầu Hoàn thành hoạt động nào khác.';
$string['completionscorerequireddesc'] = 'Yêu cầu tối thiểu {$a} điểm để hoàn thành';
$string['completionstatus_completed'] = 'Đã hoàn thành';
$string['completionstatus_passed'] = 'Đã qua';
$string['completionstatusrequired'] = 'Yêu cầu trạng thái';
$string['completionstatusrequireddesc'] = 'Học viên phải giành được ít nhất một trong các trạng thái sau: {$a}';
$string['confirmloosetracks'] = 'CẢNH BÁO: Có vẻ như gói đã bị thay đổi hoặc chỉnh sửa. Nếu cấu trúc gói đã bị thay đổi thì dữ liệu của người dùng có thể đã mất trong quá trình cập nhật.';
$string['contents'] = 'Các nội dung';
$string['coursepacket'] = 'Gói khóa học';
$string['coursestruct'] = 'Cấu trúc khóa học';
$string['currentwindow'] = 'Cửa sổ hiện tại';
$string['defaultdisplaysettings'] = 'Mặc định cài đặt hiển thị';
$string['defaultgradesettings'] = 'Mặc định cài đặt điểm';
$string['defaultothersettings'] = 'Các cài đặt mặc định khác';
$string['deleteallattempts'] = 'Xóa toàn bộ các lần làm bài trên SCORM';
$string['deleteattemptcheck'] = 'Bạn thực sự muốn xóa hết những lần làm bài này chứ?';
$string['deleteselected'] = 'Xóa những lần thử được chọn';
$string['deleteuserattemptcheck'] = 'Bạn thực sự muốn xóa hết những lần làm bài của bạn chứ?';
$string['directories'] = 'Hiển thị các đường dẫn điều hướng';
$string['disabled'] = 'Vô hiệu hóa';
$string['display'] = 'Hiển thị gói';
$string['displayattemptstatus'] = 'Hiển thị trạng thái bài làm';
$string['displaysettings'] = 'Hiển thị các cài đặt';
$string['dnduploadscorm'] = 'Thêm một gói SCORM';
$string['element'] = 'Yếu tố';
$string['enter'] = 'Nhập vào';
$string['entercourse'] = 'Nhập khóa học';
$string['eventattemptdeleted'] = 'Lần làm bài bị xóa';
$string['eventreportviewed'] = 'Báo cáo đã được xem';
$string['eventscolaunched'] = 'Sco đã được ra mắt';
$string['eventscorerawsubmitted'] = 'Đã gửi điểm SCORM trần';
$string['eventstatussubmitted'] = 'Đã gửi trạng thái SCORM';
$string['eventuserreportviewed'] = 'Báo cáo về người dùng đã được xem';
$string['everyday'] = 'Hàng ngày';
$string['everytime'] = 'Bất kể lúc nào được dùng';
$string['exceededmaxattempts'] = 'Bạn đã đạt tới số lần làm bài tối đa.';
$string['exit'] = 'Thoát khỏi khóa học';
$string['exitactivity'] = 'Thoát khỏi hoạt động';
$string['expired'] = 'Xin lỗi, hoạt động này đã kết thúc vào lúc {$a} và không còn tồn tại nữa';
$string['failed'] = 'Thất bại';
$string['finishscorm'] = 'Nếu bạn đã xem xong nguồn này, {$a}';
$string['finishscormlinkname'] = 'nhấn vào đây để quay về trang khóa học';
$string['firstaccess'] = 'Truy cập lần đầu tiên';
$string['firstattempt'] = 'Lần làm đầu tiên';
$string['forceattemptalways'] = 'Luôn luôn';
$string['forceattemptoncomplete'] = 'Khi lần làm trước đã hoàn thành, được thông qua hoặc thất bại';
$string['forcecompleted'] = 'Bắt buộc phải xong';
$string['forcecompleted_help'] = 'Nếu được kích hoạt, trang thái của bài làm hiện tại sẽ bắt buộc phải "hoàn thành" (Chỉ dành cho các gói SCORM 1.2).';
$string['forcejavascript'] = 'Bắt người dùng phải kích hoạt JavaScript';
$string['forcenewattempts'] = 'Bắt buộc bài làm mới';
$string['fromleft'] = 'Từ trái';
$string['fromtop'] = 'Từ trên';
$string['fullscreen'] = 'Toàn màn hình';
$string['general'] = 'Dữ liệu jchung';
$string['gradeaverage'] = 'Điểm trung bình';
$string['gradeforattempt'] = 'Điểm cho bài làm';
$string['gradehighest'] = 'Điểm cao nhất';
$string['grademethod'] = 'Phương pháp tính điểm';
...
$string['gradereported'] = 'Điểm đã được báo cáo';
$string['gradesettings'] = 'Cài đặt điểm';
$string['gradesum'] = 'Điểm tổng';
$string['height'] = 'Chiều cao';
$string['hidden'] = 'Bị ẩn';
$string['hidebrowse'] = 'Vô hiệu hóa chế độ xem trước';
$string['hidebrowse_help'] = 'Chế độ xem trước cho phép học viên đọc lướt qua hoạt động trước khi thực hiện nó. Nếu chế độ này bị vô hiệu hóa thì nút xem trước sẽ bị ẩn.';
$string['hidebrowsedesc'] = 'Chế độ xem trước cho phép học viên đọc lướt qua hoạt động trước khi thực hiện nó.';
$string['hideexit'] = 'Ẩn link thoát';
$string['hidereview'] = 'Ẩn nút xem lại';
$string['identifier'] = 'Câu hỏi nhận dạng';
$string['incomplete'] = 'Chưa hoàn thành';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['interactions'] = 'Các tương tác';
$string['invalidactivity'] = 'Hoạt động SCORM bị sai';
$string['invalidhacpsession'] = 'Mục HACP không hợp lệ';
$string['invalidstatus'] = 'Trạng thái không hợp lệ';
$string['invalidurl'] = 'URL đã được chỉ rõ không hợp lệ';
$string['invalidurlhttpcheck'] = 'URL đã được chỉ rõ không hợp lệ. Vá lỗi tin nhắn:<pre>{$a->cmsg}</pre>';
$string['last'] = 'Lần cuối truy cập vào lúc';
$string['lastaccess'] = 'Lần truy cập cuối';
$string['lastattempt'] = 'Lần cuối hoàn thành bài';
$string['lastattemptlock'] = 'Khóa sau bài làm cuối cùng';
$string['location'] = 'Hiển thị thanh vị trí';
$string['max'] = 'Điểm tối đa';
$string['maximumattempts'] = 'Số lần làm';
$string['maximumattempts_help'] = 'Thiết đặt này giới hạn số lần làm bài. Nó chỉ áp dụng đối với  SCORM 1.2 và các gói AICC.';
$string['menubar'] = 'Hiển thị thanh bảng chọn';
$string['min'] = 'Điểm tối thiểu';
$string['missing_tag'] = 'Thiếu tag {$a->tag}';
$string['mode'] = 'Chế độ';
