...
/**
 * Strings for component 'wavefront', language 'vi', version '4.4'.
 *
 * @package     wavefront
 * @category    string
...
$string['acceptablefiletypebriefing'] = 'Nếu bạn muốn tải lên nhiều tệp cùng một lúc, bạn có thể gửi một tệp zip có hình ảnh bên trong và tất cả các hình ảnh hợp lệ bên trong kho lưu trữ zip sẽ được thêm vào thư viện.';
...
$string['errornomodel'] = 'Không có tệp mô hình nào được tìm thấy trong thư viện này';
$string['erroruploadmodel'] = 'Các tệp bạn tải lên phải là mô hình wavefront hợp lệ';
$string['eventmodelcommentcreated'] = 'Đã tạo bình luận';
$string['eventmodelupdated'] = 'Đã cập nhật mô hình Wavefront';
$string['eventviewed'] = 'Đã xem mô hình Wavefront';
$string['invalidwavefrontid'] = 'ID Wavefront không hợp lệ';
...
$string['modulename'] = 'Trình kết xuất Wavefront';
...
$string['modulenameadd'] = 'Trình kết xuất Wavefront';
$string['modulenameplural'] = 'Các trình kết xuất Wavefront';
$string['modulenameshort'] = 'Wavefront';
$string['newmodelcomments'] = 'Nhận xét mô hình mới';
$string['nocomments'] = 'Không có bình luận';
$string['pluginadministration'] = 'Quản trị Trình kết xuất Wavefront';
$string['pluginname'] = 'Trình kết xuất Wavefront';
...
$string['wavefront:addcomment'] = 'Bình luận trên một mô hình';
$string['wavefront:edit'] = 'Chỉnh sửa mô hình';
$string['wavefront:submit'] = 'Gửi một mô hình đến thư viện';
$string['wavefront:viewcomments'] = 'Xem các bình luận về thư viện mô hình';
$string['wavefrontrenderer'] = 'Trình kết xuất Wavefront';
