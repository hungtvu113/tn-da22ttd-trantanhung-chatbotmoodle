...
/**
 * Strings for component 'mnet', language 'vi', version '4.4'.
 *
 * @package     mnet
 * @category    string
...
$string['RPC_HTTPS_VERIFIED'] = 'HTTPS (đã kí)';
$string['RPC_HTTP_SELF_SIGNED'] = 'HTTP (tự kí)';
$string['RPC_HTTP_VERIFIED'] = 'HTTP (đã kí)';
...
$string['current_transport'] = 'Chuyển giao hiện tại';
$string['currentkey'] = 'Khóa công khai hiện tại';
$string['databaseerror'] = 'Không thể viết chi tiết về CSDL.';
...
$string['forbidden-function'] = 'Chức năng đó chưa được kích hoạt đối với RPC.';
$string['forbidden-transport'] = 'Phương thức vận chuyển mà bạn đang cố dùng không được cho phép.';
$string['forcesavechanges'] = 'Bất buộc lưu thay đổi';
$string['host'] = 'máy chủ';
...
$string['id'] = 'ID';
$string['idhelp'] = 'Giá trị đã được tự động gán và không thể thay đổi được.';
...
$string['mnetidproviderdesc'] = 'Nếu bạn cung cấp địa chỉ email khớp với tên tài khoản của mình thì bạn có thể dùng chức năng này để lấy lại đường link mà bạn có thể đăng nhập vào.';
$string['mnetidprovidernotfound'] = 'Xin lỗi, không tìm thêm được những thông tin khác.';
$string['mnetservices'] = 'Dịch vụ';
$string['mnetsettings'] = 'Các thiết đặt MNet';
$string['moodle_home_help'] = 'Đường dẫn đến trang nhà của ứng dụng MNet trên máy chủ từ xa. v.d. /moodle/.';
$string['name'] = 'Tên';
$string['net'] = 'Mạng lưới';
$string['networksettings'] = 'Các thiết đặt mạng lưới';
...
$string['nopubkey'] = 'Đã có vấn đề xảy ra khi lấy lại mã công khai.<br />Có thể máy chủ không cho phép dùng MNet hoặc mã không hợp lệ.';
...
$string['privacy:metadata'] = 'Trình bổ trợ MNet không lưu trữ bất kì dữ liệu cá nhân nào.';
...
$string['receivedwarnings'] = 'Đã nhận được những cảnh báo sau đây';
...
$string['sslverification'] = 'Xác thực SSL';
...
$string['wrong-ip'] = 'Địa chỉ IP của bạn không khớp với địa chỉ mà chúng tôi có trong bản lưu.';
