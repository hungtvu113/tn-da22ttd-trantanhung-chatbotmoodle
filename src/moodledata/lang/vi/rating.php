...
/**
 * Strings for component 'rating', language 'vi', version '4.4'.
 *
 * @package     rating
 * @category    string
...
$string['privacy:metadata:rating:rating'] = 'Người dùng đã nhập đánh giá dưới dạng số.';
$string['privacy:metadata:rating:timecreated'] = 'Thời điểm lần đầu đánh giá.';
$string['privacy:metadata:rating:timemodified'] = 'Thời điểm lần cuối cập nhật đánh giá.';
$string['privacy:metadata:rating:userid'] = 'Người dùng đánh giá';
